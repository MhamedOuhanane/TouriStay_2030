    ...
    <form method="post" action="" class="my-4 px-10 space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-2 mb-6">
            <div>
                ...
                <x-text-input type="text" id="location" name="location" class="mt-1 block w-full" required autocomplete="location" placeholder="City, Countrey"/>
                <x-input-error class="mt-2" :messages="$errors->get('location')" />
            </div>
            
            <div>
                <x-input-label for="prixListing" :value="__('Price (per night)')"/>       
                <div class="relative">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            ...
            <div>
                <x-input-label for="end_date" :value="__('Start Date')" />            
